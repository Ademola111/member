# Generated by Django 5.0 on 2024-01-23 17:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_amount', models.CharField(max_length=10)),
                ('sub_status', models.CharField(default='pending', max_length=30)),
                ('sub_date', models.DateField(null=True)),
                ('sub_memberId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='members.member')),
            ],
        ),
        migrations.CreateModel(
            name='payment',
